...
export const contextPackRecordSchema = objectSchema("atlas.wiki.context-pack.v1", [...baseRequired, "query", "actor", "included_refs", "citations", "redactions", "freshness_markers", "conflict_markers", "policy_decisions"], { query: { type: "string" }, actor: { type: "object" }, included_refs: { type: "array" }, citations: { type: "array" }, redactions: { type: "array" }, freshness_markers: { type: "array" }, conflict_markers: { type: "array" }, policy_decisions: { type: "array" } });
